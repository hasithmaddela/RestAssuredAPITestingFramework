...
public class Usertests2 {
	...
	public void testGetUser() throws InterruptedException {
		...
		Response response=UserEndpoints2.getUserDetails(this.payload.getUserName());
	...
	public void testPutUser() {
		...
		Response response=UserEndpoints2.UpdateUser(this.payload,this.payload.getUserName());
		response.then().log().body();
